...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "ANJU-XPRO~6ZlVRICZ#sMk0bZUWt4zC0RxJgBoNydi5mJNLabxb1pIpGav-fF4",
    GITHUB_TOKEN: process.env.GITHUB_TOKEN || "github token without ghp_",
    GITHUB_USERNAME: process.env.GITHUB_USERNAME || "github username",https://github.com/Mr-Janith/ANJU_XPRO/
